...
function ensureCharacterIsUnique ({ user, character }) {
  ...
  return characterStore.findOne({ user, character: { normalizedName: character.normalizedName }})
...
/**
 * Returns the AWS DynamoDB endpoint, if it's set via environment variables
 *
