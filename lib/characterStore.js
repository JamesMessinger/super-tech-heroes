...
const characterStore = module.exports = {
   ...
   *
   * @param {string} params.user - The current user's ID
   * @param {Character} params.character - The character to create
   ...
   *
   * @param {string} params.user - The current user's ID
   * @param {object} params.hierarchy - The top-level character and its sidekick and/or nemesis
   ...
   *
   * @param {string} params.user - The current user's ID
   * @param {Character} params.character - The character to update
   * @returns {Promise<Character>} - Resolves with the fully-populated character object
   */
   ...
   *
   * @param {string} params.user - The current user's ID
   * @param {string} params.id - The ID of the character to delete
   ...
   *
   * @param {string} params.user - The current user's ID
   * @param {Character} params.character - The character to find or create
   ...
   *
   * @param {string} params.user - The current user's ID
   * @param {string} [params.id] - The ID of the character to find
   * @param {string} [params.normalizedName] - The normalized name of the character to find
   * @returns {Promise<Character>} - Resolves with the existing or newly-created character
   */
   ...
   *
   * @param {string} params.user - The current user's ID
   * @param {string} [params.name] - The character name to search for
   * @param {string} [params.type] - The type of characters to search for
   ...
   *
   * @param {Character[]} params.characters - The characters to populate
 ...
 *
 * @param {string} params.user - The current user's ID
 * @param {Character} params.character - The character to check
 * @returns {Promise}
 */
