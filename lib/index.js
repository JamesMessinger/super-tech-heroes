...
const routes = [
  {
    pattern: /^\/?$/i,
    GET: './handlers/apiInfo',
  },
  {
    pattern: /^\/schema\/?$/i,
    GET: './handlers/apiSchema.js',
  },
  {
    pattern: /^\/characters\/?$/i,
    GET: './handlers/findCharacters',
    POST: './handlers/createCharacter',
    DELETE: './handlers/deleteAllCharacters',
  },
  {
    pattern: /^\/characters\/(.+?)\/?$/i,
    GET: './handlers/getCharacter',
    PUT: './handlers/updateCharacter',
  },
];
