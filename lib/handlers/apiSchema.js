...
const formats = [
  ...
  {
    schemaPath: 'schemas/swagger.json',
  ...
  {
    schemaPath: 'schemas/swagger.yaml',
  ...
  {
    schemaPath: 'schemas/postman-collection.json',
    contentType: 'application/postman+json;version=2.0',
    accept: [
      'application/postman',
      'application/postman+json',
